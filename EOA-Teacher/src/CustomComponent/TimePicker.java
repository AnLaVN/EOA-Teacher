...
public class TimePicker extends javax.swing.JPanel {
    ...
    private void displayOnText() {
        ...
        if(displayTextLabel != null){
            ...
            //displayTextLabel.setText(displayTextLabel.getText());
        }
    }
    ...
    private void initComponents() {
        ...
        lbSplit = new CustomComponent.TimePickerLabel();
        panel = new javax.swing.JPanel();
        cmdAM = new CustomComponent.TimePickerButton();
        cmdPM = new CustomComponent.TimePickerButton();
        cmdHour = new CustomComponent.TimePickerButton();
        cmdMinute = new CustomComponent.TimePickerButton();
        timeComponent = new CustomComponent.TimeComponent();
        cmdOK = new CustomComponent.TimePickerButton();
        cmdCancel = new CustomComponent.TimePickerButton();
    ...
    private CustomComponent.TimePickerButton cmdAM;
    private CustomComponent.TimePickerButton cmdCancel;
    private CustomComponent.TimePickerButton cmdHour;
    private CustomComponent.TimePickerButton cmdMinute;
    private CustomComponent.TimePickerButton cmdOK;
    private CustomComponent.TimePickerButton cmdPM;
    private javax.swing.JPanel header;
    private CustomComponent.TimePickerLabel lbSplit;
    private javax.swing.JPanel panel;
    private javax.swing.JPanel panelHeader;
    private CustomComponent.TimeComponent timeComponent;
