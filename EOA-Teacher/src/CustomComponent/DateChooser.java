...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private final String MONTH_ENGLISH[] = 
    ...
    private void initComponents() {
        ...
        cmdForward = new CustomComponent.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new CustomComponent.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new CustomComponent.Button();
        cmdPrevious = new CustomComponent.Button();
        slide = new CustomComponent.Slider();
        ...
        cmdForward.setIcon(new javax.swing.ImageIcon(getClass().getResource("/CustomComponent/forward.png"))); // NOI18N
        ...
        cmdPrevious.setIcon(new javax.swing.ImageIcon(getClass().getResource("/CustomComponent/previous.png"))); // NOI18N
    ...
    private CustomComponent.Button cmdForward;
    private CustomComponent.Button cmdMonth;
    private CustomComponent.Button cmdPrevious;
    private CustomComponent.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private CustomComponent.Slider slide;
